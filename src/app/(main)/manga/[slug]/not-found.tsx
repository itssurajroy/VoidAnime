      ...
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        >
          ...
          <h1 className="text-4xl font-heading font-black text-white leading-tight">
            Manga <span className="glow-text text-anime-primary">Not Found</span>
          </h1>

          <p className="text-zinc-400 text-sm leading-relaxed max-w-sm mx-auto font-medium">
            The chapter you're seeking has vanished from our library. It may have been removed or the ID is incorrect.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {['One Piece', 'Jujutsu Kaisen', 'Berserk', 'Vagabond', 'Kingdom'].map(title => (
              <Link key={title}
