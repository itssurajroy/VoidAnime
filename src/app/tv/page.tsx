...
export default async function TVSeriesPage({
  ...
  let data;
  try {
    const res = await getCategoryAnimes('tv', page);
    data = res.data;
  } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0C10] text-white selection:bg-primary/30 pb-32 relative overflow-hidden">
      ...
      <CatalogHero 
        title="TV Series"
        subtitle="Episodic storytelling and long-running sagas. High-speed broadcast production index."
      ...
      <div className="container max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16 py-20 relative z-10">
        <div className="space-y-12">
            <div className="flex items-center justify-between">
                <h2 className="text-white/40 text-[12px] font-black uppercase tracking-[0.4em]">Broadcast Catalog</h2>
